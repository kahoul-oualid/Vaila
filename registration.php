...
<h2 class="tbr-txt-two">قم بإنشاء حساب فايلا الخاص بك</h2>

<h4 class="tbr-txt-three">لديك حساب بالفعل؟
<a class="tbr-link" href="login.php"> سجل الدخول</a>
</h4>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="tbr-forms">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for=""></label>
                                    <input type="submit" class="btn tbr-btn-success" value="<?php echo LANG_VALUE_15; ?>" name="form1">
                                </div>
                            </div>
                        </div>                        
                    </form>
